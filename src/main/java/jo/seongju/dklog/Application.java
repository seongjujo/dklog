...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        try (InputStream inputStream = getInputStream()) {
            ...
            System.err.println("error: 찾을 수 없는 log 파일경로입니다.");

        } catch (IOException e) {
            System.err.println("error: log 파일 처리 실패.");

        } catch (ReadLogException e) {
            System.err.println("error: log 파일 읽기 실패.");

        } catch (WriteLogException e) {
            System.err.println("error: log 파일 출력 실패.");

        } catch (Exception e) {
            System.err.println("error: 알 수 없는 시스템 장애입니다.");
